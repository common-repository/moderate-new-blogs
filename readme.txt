...
== Description ==
WordPress [Multisite](http://codex.wordpress.org/Create_A_Network) Network plugin. New blogs(aka sites) await a final click from a Network Admin to activate. This plugin flags new blogs in Network Admin-->Sites as "Awaiting Moderation". 
